...
- Light cleanup note: notebook path is `012 - Spoken Word Recognition/spoken_word_recognition.ipynb`.
- Blocker: Vivian cloud Linux is CPU-only (no MPS/GPU); full nbconvert execute deferred until Vishnu approves a long run or a GPU/Mac host.
