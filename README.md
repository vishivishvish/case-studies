...
|---|---|---|---|---|---|
| 1 | [Targeted Alpha Therapy](001%20-%20Targeted%20Alpha%20Therapy/targeted_alpha_therapy.ipynb) | Nuclear medicine | Nuclear binding energy per nucleon from proton/neutron counts (AME2020, ~3,554 nuclides) | The Semi-Empirical Mass Formula (Bethe-Weizsacker, 1935), found independently via SHAP | Retrofit in progress |
| 2 | [EEG Motor Imagery](002%20-%20EEG%20Motor%20Imagery/eeg_motor_imagery.ipynb) | Neuroscience / brain-machine interfaces | Left vs. right hand motor imagery from 64-channel EEG (PhysioNet, 109 subjects) | Pfurtscheller's event-related desynchronization and Penfield's motor homunculus (C3/C4 lateralization) | Pending retrofit |
| 3 | [Humanoid Robot Grasp Prediction](003%20-%20Humanoid%20Robot%20Grasp%20Prediction/grasp_prediction.ipynb) | Robotics | Grasp rectangle for household objects from RGB images (synthetic Cornell Grasping replica) | Napier's Power/Precision Grip dichotomy (1956) and Gibson's affordances (1979) | Pending retrofit |
...
| 10 | [Network Intrusion Detection](010%20-%20Network%20Intrusion%20Detection/network_intrusion_detection.ipynb) | Network security | Benign vs. SYN-flood/port-scan/brute-force network flows | Denning's statistical anomaly-detection model (1987) | Full 8 stages |
